...
const herois = document.querySelectorAll('.herois');
...
botoes.forEach((botao, indice) => {
  botao.addEventListener("click", () => {
    ...
    herois[indice].classList.add("selecionado");

  });
});

function desselecionarHerois() {
  const heroisSelecionado = document.querySelector(".herois.selecionado");
  heroisSelecionado.classList.remove("selecionado");
}
